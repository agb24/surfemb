    ...
    '''def postprocess(self, preds, img, orig_imgs):
        ...
        for i, pred in enumerate(preds):
            ...
            if not isinstance(orig_imgs, torch.Tensor):
                ...
                #pred[:, :4] = ops.scale_boxes(img.shape[1:3], pred[:, :4], orig_img.shape)
            path = self.batch[0]
...
def predict(cfg=DEFAULT_CFG, use_python=False):
    ...
    #model = "/home/ise.ros/akshay_work/NN_Implementations/surfemb/runs/detect/train_update_11_cont_lr0025_600ep/weights/best.pt"
    model = "/home/ise.ros/akshay_work/NN_Implementations/surfemb/runs/detect/pbr_blk_trn_200/weights/best.pt"
    
    source = "/home/ise.ros/akshay_work/datasets/tless_generated/tless/train_pbr/000002/rgb/000120.jpg"
    #source = "/home/ise.ros/akshay_work/NN_Implementations/surfemb/surfemb/scripts/dataset_img_detec/test_img3.jpg"
    #source = "/home/ise.ros/akshay_work/NN_Implementations/surfemb/surfemb/scripts/dataset_img_detec/tless/test_primesense/000001/rgb/000001.png"
    ...
    if use_python:
        ...
        init_preds = predictor.model(predictor.preprocess(image),
                                      augment=True)
        predictions = predictor.postprocess(init_preds, image, source)
        print(predictions[0].boxes.xywh, predictions[0].boxes.xyxy)'''
